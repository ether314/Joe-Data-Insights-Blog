/**
 * AI capex & spend concentration — top-1 / top-3 shares, HHI, cumulative ladder,
 * and raise-concentration across Big-5 hyperscaler gross programs.
 * Complements the theme's absolute-dollar posts with a distribution lens.
 */

export type Confidence = "actual" | "guidance" | "midpoint" | "desk" | "net-of-prepay";

export const SOURCE_NOTE =
  "Concentration lens on Big-5 hyperscaler gross capex. Late-Aug 202608 vintage: Amazon ~$240B, Alphabet mid $218B, Microsoft ~$175B CY (lease reclass), Meta mid $150B, Oracle ~$75B net → Big-5 sum ~$858B. Historical 2024–2025 from company filings; Jul research vintage (~$760B) and Aug/Q3 path from theme updates. AI-attributed factor ≈75% of gross (CreditSights convention). Shares and HHI are within the Big-5 perimeter, not the entire global IT capex universe.";
...
export const SOURCES = [
  ...
  {
    label: "Hyperscaler capex intensity",
...
export const HEADLINE = {
  ...
  hhi: 2227,
  /** Equal five-way share would be 20% each; HHI = 2,000 */
  equalShareHhi: 2000,
  aiShareOfGross: 0.75,
  aiSliceBn: 644,
  /** Jul research → late-Aug cumulative raise */
  julBig5: 760,
  julToAug20DeltaBn: 98,
  /** Share of positive Jul→Aug20 dollar raises from Amazon+Alphabet */
  top2RaiseSharePct: 64.6,
  amazonRaiseBn: 40,
  alphabetRaiseBn: 33,
  /** Top-1 share path */
  ...
  top1ShareAug2026Pct: 28.0,
  /** Top-3 share path */
  top3Share2024Pct: 79.2,
  top3Share2025Pct: 76.7,
  top3ShareJul2026Pct: 75.7,
  top3ShareAug2026Pct: 73.8,
} as const;
...
/** Ranked 2026 late-Aug share ladder (descending) */
...
export const SHARE_LADDER_2026: ShareRow[] = [
  {
    company: "Amazon",
    bn: 240,
    sharePct: 28.0,
    ...
    note: "Largest single program; AWS / capacity commentary drove late-Aug raise",
  },
  {
    company: "Alphabet",
    bn: 218,
  ...
  },
  {
    ...
    note: "Accounting CY; economic build nearer ~$190B if lease reclass reversed",
  },
  {
    company: "Meta",
    bn: 150,
...
export type CapexYearKey = "2024" | "2025" | "2026-jul" | "2026-aug";

/** Gross company capex by vintage (USD bn) — ordered for share math */
...
> = {
  ...
  "2026-jul": { Amazon: 200, Alphabet: 185, Microsoft: 190, Meta: 135, Oracle: 50 },
  "2026-aug": { Amazon: 240, Alphabet: 218, Microsoft: 175, Meta: 150, Oracle: 75 },
};
...
/** Lorenz / cumulative concentration curve points (equal-split diagonal + actual) */
...
export const CONCENTRATION_PATH = (
  ["2024", "2025", "2026-jul", "2026-aug"] as CapexYearKey[]
).map((year) => {
...
/** Jul research → late-Aug company deltas (raise concentration) */
...
export const RAISE_ROWS: RaiseRow[] = [
  {
    ...
    deltaBn: 40,
    fill: COMPANY_COLORS.Amazon,
    note: "Largest absolute raise across three refreshes",
  },
  {
    company: "Alphabet",
    julBn: 185,
    ...
    deltaBn: 33,
    fill: COMPANY_COLORS.Alphabet,
    note: "Four guidance steps from low-$180Bs to $218B mid",
  },
  {
    company: "Oracle",
    julBn: 50,
  ...
  },
  {
    ...
    deltaBn: -15,
    fill: COMPANY_COLORS.Microsoft,
    note: "Lease reclass — economic build did not fall with the headline",
  },
];

/** Positive-only raise shares for donut (Microsoft excluded as negative) */
...
/** Scenario / perimeter comparison — absolute stacks vs Big-5 share lens */
...
export const PERIMETER_STACKS: PerimeterRow[] = [
  ...
  },
  {
    ...
    bn2026: 845,
    color: "#8b5cf6",
    note: "Catch-up to official raises",
  },
  {
    id: "credit",
    label: "CreditSights",
