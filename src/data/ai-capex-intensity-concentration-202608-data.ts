/**
 * Capex intensity concentration — late-Aug 202608 vintage.
 ...
 * extreme of reinvestment / revenue under the late-Aug desk refresh.
 */
...
export const SOURCES = [
  {
    label: "Late-Aug intensity update",
    url: "/blog/ai-capex-intensity-update-202608",
  },
  {
    label: "Q3 intensity concentration companion",
    url: "/blog/ai-capex-intensity-concentration-2026q3",
  },
  {
    label: "Late-Aug spend concentration",
    url: "/blog/ai-capex-spend-concentration-202608",
  },
  {
...
/** Late-Aug headline (intensity-sum perimeter) — primary vintage for this post */
...
export const SHARE_LADDER_AUG = shareLadder("aug-20", "intensity-sum");
...
export const PERIMETER_COMPARE = COMPANIES.map((company) => {
  const intensity = SHARE_LADDER_AUG.find((r) => r.company === company)!;
