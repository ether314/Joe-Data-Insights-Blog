/**
 * Fiscal plumbing — Q3 2026 concentration / market-share lens.
 ...
 *
 * Complements fiscal-plumbing-concentration-2026 (baseline concentration print)
 * and the Q3 / Aug update vintages (what moved) with a distribution cut on the
 * newest official prints: Top-1 / Top-3 / HHI across tax expenditures, trust-fund
 * outlays, off-balance credit stocks, and the editorial plumbing-layer map —
 * plus a vintage slope vs the 2026 concentration baseline.
 *
 * Primary anchors (disclosed roundings; see SOURCE_NOTE):
 * - CRFB/JCT fall-2026 refresh (~$2.51T TE path) + top-10 line items
 * - SSA / Medicare Trustees 2026 (carried depletion years; rounded costs)
 * - FHFA / ED / FDIC late-Q3 outstanding / exposure stocks
 */

export type Confidence = "disclosed" | "estimated" | "carried";

export const SOURCE_NOTE =
  "Q3 concentration lens on US fiscal plumbing after the CRFB/JCT fall-2026 refresh and late-Q3 stock prints. Tax-expenditure totals and top-10 ranking: CRFB summary of JCT (~$2.51T path). Trust-fund outlays/reserves/depletion years: 2026 SSA and Medicare Trustees framing (carried clocks; rounded costs). Off-balance stocks: late-Q3 public outstanding/exposure (FHFA GSE MBS, ED Direct Loans, FDIC insured deposits, FHA/VA, PBGC). Plumbing-layer pie is an editorial composition map of annual flows — not a single CBO table. Prior-print meters cite fiscal-plumbing-concentration-2026. Tax expenditures interact; do not sum line items as a joint repeal score. HHI values are analytical indexes on the stated bucket shares (0–10,000).";
...
export const HEADLINE = {
  /** Top-1 tax expenditure as share of JCT fall-2026 aggregate */
  teTop1Pct: 15.8,
  teTop1Label: "Pensions / retirement exclusion",
  teTop1Bn: 396,
  teTop1PriorPct: 15.4,
  /** Top-3 tax expenditures as share of JCT fall-2026 aggregate */
  teTop3Pct: 37.6,
  teTop3Bn: 945,
  teTop3PriorPct: 36.8,
  teUniverseTn: 2.51,
  teUniversePriorTn: 2.3,
  teTop10Bn: 1586,
  teTop10ShareOfTotalPct: 63.2,
  teHhiOnTop10: 1475,
  teHhiPrior: 1486,
  /** Trust-fund outlay concentration (OASI+DI+HI+SMI; no OASDI double-count) */
  trustTop1Pct: 54.3,
  trustTop1Label: "OASI",
  trustTop1PriorPct: 54.5,
  trustTop3Pct: 94.0,
  trustTop3PriorPct: 93.9,
  trustOutlayBn: 2798,
  trustHhi: 3797,
  trustHhiPrior: 3812,
  ...
  offTop1PriorPct: 47.0,
  offTop3Pct: 91.2,
  offTop3PriorPct: 91.3,
  offStockTn: 23.55,
  offStockPriorTn: 22.35,
  offHhi: 3527,
  offHhiPrior: 3568,
  /** Editorial plumbing-layer annual-flow concentration */
  layerTop1Pct: 29.5,
  layerTop1Label: "Tax expenditures (JCT)",
  layerTop1PriorPct: 29.4,
  layerTop3Pct: 78.3,
  layerTop3PriorPct: 79.3,
  layerUniverseBn: 8495,
  layerHhi: 2339,
  layerHhiPrior: 2284,
...
/** JCT fall-2026 top-10 tax expenditures ranked; shares vs $2.51T aggregate. */
export const TE_SHARES: ShareRow[] = [
  ...
  },
  {
    ...
    confidence: "estimated",
    fill: "#94a3b8",
    note: "Closes $2.51T after disclosed/estimated top-10; hundreds of smaller items",
  },
];

export const TE_CONCENTRATION_CURVE = [
  { rank: 0, label: "0", sharePct: 0, equalPct: 0 },
  { rank: 1, label: "Top-1", sharePct: 15.8, equalPct: 9.1 },
  { rank: 2, label: "Top-2", sharePct: 27.0, equalPct: 18.2 },
  { rank: 3, label: "Top-3", sharePct: 37.6, equalPct: 27.3 },
  { rank: 5, label: "Top-5", sharePct: 47.8, equalPct: 45.5 },
  { rank: 10, label: "Top-10", sharePct: 63.2, equalPct: 90.9 },
...
export const TRUST_CONCENTRATION_CURVE = [
  ...
  { rank: 2, label: "Top-2", sharePct: 77.7, equalPct: 50 },
  { rank: 3, label: "Top-3", sharePct: 94.0, equalPct: 75 },
  { rank: 4, label: "All", sharePct: 100, equalPct: 100 },
];

/** Off-balance / credit-guarantee outstanding stocks (late-Q3). */
...
export const OFF_CONCENTRATION_CURVE = [
  { rank: 0, label: "0", sharePct: 0, equalPct: 0 },
  { rank: 1, label: "Top-1", sharePct: 46.1, equalPct: 20 },
  { rank: 2, label: "Top-2", sharePct: 81.5, equalPct: 40 },
  { rank: 3, label: "Top-3", sharePct: 91.2, equalPct: 60 },
...
export const LAYER_SHARES: ShareRow[] = [
  {
    id: "tax-code",
    label: "Tax expenditures (JCT fall refresh)",
    short: "Tax code",
    value: 2510,
    unit: "bn",
    sharePct: 29.5,
    cumulativeSharePct: 29.5,
    confidence: "disclosed",
    fill: "#f59e0b",
  },
  {
...
export const LAYER_CONCENTRATION_CURVE = [
  { rank: 0, label: "0", sharePct: 0, equalPct: 0 },
  { rank: 1, label: "Top-1", sharePct: 29.5, equalPct: 20 },
  { rank: 2, label: "Top-2", sharePct: 57.9, equalPct: 40 },
  { rank: 3, label: "Top-3", sharePct: 78.3, equalPct: 60 },
  { rank: 5, label: "All", sharePct: 100, equalPct: 100 },
];
...
export const LENS_COMPARE = [
  {
    ...
    unitNote: "Share of JCT $2.51T fall refresh",
    fill: "#f59e0b",
  },
  {
  ...
  },
  {
    ...
    unitNote: "Share of ~$23.6T credit/guarantee stock",
    fill: "#8b5cf6",
  },
  {
...
/** Vintage slope: 2026 concentration print → Q3 fall refresh. */
...
export const TE_FAMILY_STACK = [
  { family: "Retirement", bn: 396, fill: "#0ea5e9" },
  { family: "Capital", bn: 281 + 82, fill: "#8b5cf6" },
  { family: "Health", bn: 268 + 118, fill: "#f43f5e" },
  { family: "Income support", bn: 138 + 71, fill: "#14b8a6" },
  { family: "Business / charity / other", bn: 83 + 84 + 65, fill: "#64748b" },
];

/** Prior vs newest Top-1 delta by lens (pp). */
...
export const SOURCES = [
  "Joint Committee on Taxation tax expenditure estimates (fall-2026 refresh / FY2027–28 path), via CRFB",
  "CRFB — JCT aggregate restatement (~$2.51T) and top-line rankings",
  "Prior concentration print — fiscal-plumbing-concentration-2026 (JCT ~$2.3T baseline meters)",
  "SSA / Medicare Trustees Reports 2026 (carried depletion years; rounded costs and reserves)",
  "FHFA / ED / FDIC late-Q3 2026 stock figures for GSE MBS, Direct Loans, insured deposits (rounded)",
  "CBO late-summer 2026 baseline — net interest framing (~$1.12T)",
];
