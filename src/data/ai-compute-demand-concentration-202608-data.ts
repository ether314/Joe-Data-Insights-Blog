/**
 * AI compute demand — Aug 2026 concentration lens (Top-1 / Top-3 / location bands).
 *
 ...
 *
 * Vintage delta vs ai-compute-demand-concentration-2026q3:
 * 1. Chip ownership — carried (Google 25% / Top-3 54.8% / Big-5 71.4%)
 * 2. Hyperscale cloud Top-3 — Aug Synergy location print 57% (Q3 was 58%; −1 pp)
 * 3. Pipeline ledger — 915 sites (+112 vs Q3 hyperscale 803); dual-hub 17%
 * 4. Top-20 markets — 60% of world hyperscale capacity; 15 US / 4 APAC / 1 EU seats
 * 5. Token cohort — carried from Q3 (Google Top-1 ~27%); Aug print does not restate tokens
 * 6. Gartner US electricity — carried (US 36% of world DC TWh; ~68 TWh AI inside US)
 */

export type Confidence = "disclosed" | "estimated" | "carried" | "restated";

export const SOURCE_NOTE =
  "Aug 2026 concentration lens on four perimeters. Chip ownership: Epoch Chip Owners / Aug explorer Big-5 H100e — carried (no new Epoch period print). Hyperscale sites/capacity: Synergy Aug 19 location rankings (pipeline 915; Top-3 cloud 57%; dual-hub N.VA+Beijing 17%; top-20 = 60%) vs Q3 hyperscale ledger (1,360 ops / 803 pipeline; Top-3 cloud 58%). Regional AI DC power-draw shares: theme synthesis carried (~US 45%). Token shares: Q3 brand cohort carried — Google leads tokens (~27%). Gartner US electricity composition (204 TWh / 36% of world DC). Shares within each perimeter sum ≈100%; cross-perimeter comparisons are illustrative.";
...
export const SOURCES = [
  ...
  },
  {
    ...
    url: "/blog/ai-compute-demand-concentration-2026q3",
  },
  {
...
/** Headline punchline — Aug Top-1 / Top-3 across ownership, sites, tokens */
export const HEADLINE = {
  ...
  /** Hyperscale cloud — Aug Synergy location print */
  cloudTop3Pct: 57,
  ...
  /** Site / pipeline concentration (Aug location mix) */
  worldOpsSites: 1360,
  usOpsSites: 580,
  usOpsSiteSharePct: 42.6,
  worldPipelineSites: 915,
  priorPipelineSitesQ3: 803,
  ...
  /** Token throughput — Q3 brand cohort carried */
  tokenTop1Pct: 27,
...
export const SCOREBOARD: ScoreboardRow[] = [
  {
    ...
    color: "#4285f4",
    confidence: "carried",
    note: "Carried — Epoch Q1/Q2 2026 period print still open",
  },
  {
    id: "cloud",
    ...
    extraMetric: "vs Q3 Top-3",
    extraValue: `${HEADLINE.cloudTop3PriorPct}% → ${HEADLINE.cloudTop3Pct}%`,
    priorTop3Pct: HEADLINE.cloudTop3PriorPct,
    color: "#f59e0b",
    confidence: "disclosed",
    note: "Aug Synergy location rankings; dual-hub is N.VA+Beijing",
  },
  {
    id: "sites",
    label: "Top-20 market capacity",
    top1Pct: HEADLINE.dualHubPct,
    top1Label: "N.VA + Beijing",
    top3Pct: HEADLINE.marketTop20Pct,
    top3Labels: "Top-20 markets (capacity)",
    extraMetric: "Pipeline sites",
    extraValue: `${HEADLINE.worldPipelineSites} (+${HEADLINE.pipelineSitesDelta} vs Q3)`,
    priorTop3Pct: null,
    color: "#0ea5e9",
    confidence: "disclosed",
    note: "Aug location mix — top-20 = 60%; US holds 15 of 20 seats",
  },
  {
    id: "tokens",
    ...
    color: "#f43f5e",
    confidence: "carried",
    note: "Q3 cohort carried — Aug location print does not restate tokens",
  },
];
...
export const OWNERS: OwnerRow[] = [
  ...
  },
  {
    ...
    confidence: "carried",
    color: "#00a4ef",
    note: "Aug explorer restatement — still carried",
  },
  {
    id: "amazon",
    label: "Amazon",
...
export type ConcPathPoint = {
  ...
  marketTop20Pct: number | null;
  tokenTop1Pct: number | null;
  confidence: Confidence;
};

/** Multi-vintage concentration path — Aug adds location Top-20 meter */
...
/** US vs rest-of-world — Aug pipeline expands; US share held ~54% */
...
export const REGIONS: RegionRow[] = [
  ...
  },
  {
    ...
    confidence: "estimated",
    color: "#8b5cf6",
    note: "Dublin sole EU top-20; Nordics / UK / France grid friction",
  },
  {
    id: "middle-east",
    label: "Middle East",
  ...
  },
  {
    ...
    confidence: "estimated",
    color: "#14b8a6",
    note: "4 APAC seats in top-20 (ex-China metros + ANZ/SEA)",
  },
  {
    id: "latam-other",
    label: "LatAm & other",
...
export const CLOUD_SLICES: CloudSlice[] = [
  {
    ...
    priorSharePct: 58,
    color: "#f59e0b",
    note: "Aug Top-3 cloud share (−1 pp vs Q3 capacity print)",
  },
  {
    id: "rest",
...
/** Top-20 seat composition — Aug Synergy location rankings */
export const MARKET_SEATS: MarketSeatRow[] = [
  {
    id: "us",
    label: "United States",
    ...
    seats: 15,
    color: "#0ea5e9",
    note: "15 of 20 top markets — inland corridor rising",
  },
  {
    id: "apac",
    label: "APAC (ex dual-hub split)",
    region: "APAC",
    seats: 4,
    color: "#14b8a6",
    note: "4 APAC seats in the global top-20",
  },
  {
    id: "europe",
    label: "Europe",
    ...
    seats: 1,
    color: "#8b5cf6",
    note: "Dublin only — sole European top-20 seat",
  },
];
...
/** Token ladder — carried from Q3; Google still Top-1 */
export const TOKEN_BRANDS: TokenBrandRow[] = [
  {
    ...
    priorSharePct: 19.0,
    color: "#4285f4",
    note: "Carried Q3 Top-1 tokens; also Top-1 ownership",
  },
  {
    id: "bytedance",
    label: "ByteDance",
    ...
    priorSharePct: 29.2,
    color: "#f43f5e",
    note: "Prior June Top-1; still #2 — usage >> ownership",
  },
  {
    id: "openai",
    label: "OpenAI",
  ...
  },
  {
    ...
    priorSharePct: 22.4,
    color: "#64748b",
    note: "Residual of Q3 cohort (carried into Aug lens)",
  },
];
...
/** Q3 → Aug concentration deltas (percentage meters only) */
export const DELTA_METERS: DeltaMeter[] = [
  {
    ...
    delta: -1,
    color: "#f59e0b",
    note: "Q3 Synergy capacity → Aug location rankings",
  },
  {
    id: "dual-hub",
    ...
    delta: 0,
    color: "#ea580c",
    note: "N.VA + Beijing still 17% of world hyperscale",
  },
  {
    id: "owner-top3",
  ...
  },
  {
    ...
    delta: 0,
    color: "#0ea5e9",
    note: "Disclosed Aug band — US holds 15 of 20 seats",
  },
];
...
export function marketBandCurve() {
  return concentrationCurve(MARKET_BANDS.map((m) => m.sharePct));
}
