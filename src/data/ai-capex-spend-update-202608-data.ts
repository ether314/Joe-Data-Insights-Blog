/**
 * AI capex & spend totals — late-Aug 202608 vintage update (20 Aug 2026).
 * Compares the mid-Q3 desk print (Big-5 midpoints ~$835B) against the newest
 * Axis tracker / Street catch-up vintage after late-August infra commentary.
 * Figures USD billions; scopes intentionally labeled.
 */

export const SOURCE_NOTE =
  "202608 vintage delta: mid-Q3 desk print (Big-5 midpoints ~$835B) vs late-Aug Axis / Street refresh. Amazon ~$240B, Alphabet $210–225 mid $218B, Meta $145–155 mid $150B, Microsoft ~$175B CY (lease reclass still in force), Oracle ~$75B net of prepayments. Big-5 midpoints sum ~$858B (+$23B / +2.8% vs mid-Q3). Street ~$845B; CreditSights ~$850B. AI-attributed factor ≈75% of gross (CreditSights convention).";

export const SOURCES = [
  {
    label: "Axis Intelligence Research AI Capex Tracker (late-Aug 202608 refresh)",
    url: "https://axis-intelligence.com/ai-capex-tracker/",
  },
  {
    label: "Prior vintage — AI capex spend update (mid-Q3)",
    url: "/blog/ai-capex-spend-update-2026q3",
  },
  {
    label: "Aug post-Q2 vintage — AI capex spend update",
...
export const HEADLINE = {
  ...
  yoy2025: 344,
  yoyGrowthPct: 149,
  /** Jul research → Aug → Q3 → 202608 cumulative path */
  julBig5: 760,
  augBig5: 802.5,
  q3Big5: 835,
  aug20Big5: 858,
  julToAug20DeltaBn: 98,
  julToAug20DeltaPct: 12.9,
  q3ToAug20DeltaBn: 23,
  q3ToAug20DeltaPct: 2.8,
} as const;
...
/** Company midpoints — prior = mid-Q3 desk; new = late-Aug 202608 vintage */
export const COMPANY_VINTAGE: VintageCompany[] = [
  {
    company: "Amazon",
    priorBn: 230,
    newBn: 240,
    priorLabel: "Mid-Q3 desk ~$230B",
    newLabel: "Late-Aug ~$240B",
    confidence: "desk",
    note: "Largest absolute raise again (+$10B); AWS capacity commentary",
  ...
  },
  {
    ...
    priorBn: 175,
    newBn: 175,
    priorLabel: "Mid-Q3 ~$175B CY",
    newLabel: "Late-Aug ~$175B CY",
    confidence: "call",
  ...
  },
  {
    ...
    priorBn: 210,
    newBn: 218,
    priorLabel: "Mid-Q3 $205–215 mid",
    newLabel: "Late-Aug $210–225 mid",
    confidence: "midpoint",
    note: "Fourth raise of the year; ceiling steps with GCP infra path",
  ...
  },
  {
    ...
    priorBn: 145,
    newBn: 150,
    priorLabel: "Mid-Q3 $140–150 mid",
    newLabel: "Late-Aug $145–155 mid",
    confidence: "midpoint",
    note: "Ceiling stepped; finance-lease principal still in the stack",
  ...
  },
  {
    ...
    priorBn: 75,
    newBn: 75,
    priorLabel: "Mid-Q3 ~$75B net",
    newLabel: "Late-Aug ~$75B net",
    confidence: "net-of-prepay",
    note: "Net of customer prepayments unchanged; gross still ~$95–100B",
...
/** Waterfall steps for Big-5 vintage revision (Q3 → 202608) */
export function waterfallSteps(active: Hyperscaler[] = [...HYPERSCALERS]) {
  const deltas = companyDeltas(active);
  const priorSum = Math.round(deltas.reduce((s, d) => s + d.priorBn, 0) * 10) / 10;
  const steps: {
    name: string;
    start: number;
    end: number;
...
/** Research-house annual scenarios — mid-Q3 vs late-Aug 202608 */
export const SCENARIO_VINTAGE: ScenarioVintage[] = [
  ...
  },
  {
    ...
    y2027: 1005,
    color: "#64748b",
    note: "Consensus catching the mid-Q3 + late-Aug raises",
  },
  {
    id: "creditsights",
    ...
    y2027: null,
    color: "#f59e0b",
    note: "Credit-desk aggregate after late-August refresh",
  },
  {
    id: "gs-gi",
...
/** Cumulative revision path: Jul → Aug → Q3 → late-Aug 202608 */
export const REVISION_PATH: RevisionPoint[] = [
  ...
  {
    vintage: "Aug-20 202608",
    big5: 858,
    street: 845,
    credit: 850,
    gsIr: 815,
    label: "Axis late-Aug official vintage",
  },
];
...
export type YoYRow = {
  ...
  oracle: number;
  total: number;
  vintage: "actual" | "jul-guide" | "aug-guide" | "q3-guide" | "aug20-guide" | "consensus";
};

/** Stack continuity: actuals + four 2026 vintages + 2027E */
...
/** Delta contribution ranks for horizontal bar panel */
export function deltaRank(active: Hyperscaler[] = [...HYPERSCALERS]) {
  return companyDeltas(active)
    .map((d) => ({
      company: d.company,
      deltaBn: d.deltaBn,
      fill: d.fill,
    ...
    .sort((a, b) => Math.abs(b.deltaBn) - Math.abs(a.deltaBn));
}
